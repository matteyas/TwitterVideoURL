# TwitterVideoURL / Twitter Video Download
...
# Explanation
1. The script hooks into XML requests
2. Once the appropriate request response is found, it extracts the MP4 URL (hook is removed)
3. Finally, it injects a clickable button on the webpage that redirects to the URL
